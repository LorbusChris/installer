...
require (
	...
	github.com/terraform-providers/terraform-provider-aws v1.60.1-0.20191213191620-22eb4b05ccb2
	github.com/terraform-providers/terraform-provider-azuread v0.7.0 // indirect
	github.com/terraform-providers/terraform-provider-azurerm v1.39.0
...
replace (
	github.com/Azure/azure-sdk-for-go => github.com/hashicorp/azure-sdk-for-go v36.2.2-hashi+incompatible // Pin to version pinned by tf-provider-azurerm
	...
	github.com/hashicorp/terraform => github.com/LorbusChris/terraform v0.12.18-0.20191218013227-c06a0a789567 // Pin OpenShift fork
	github.com/hashicorp/terraform-plugin-sdk => github.com/LorbusChris/terraform-plugin-sdk v1.4.1-0.20191218013551-33541515cfe4 // Pin OpenShift fork
	...
	k8s.io/kubelet => k8s.io/kubelet v0.0.0-20190831152136-ba9cf7ec6904 // Pinned by MCO
	k8s.io/kubernetes => github.com/openshift/kubernetes v1.16.0-beta.0.0.20190913145653-2bd9643cee5b // Replaced by MCO
